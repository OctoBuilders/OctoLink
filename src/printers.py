...
class Printer():
    ...
    material_type      : str
    material_colour    : str
    currently_printing : Job


    def __init__(self, ip_address, port, api_key, pretty_name=None, location=None, material_type=None, material_colour=None, printer_type=None):
